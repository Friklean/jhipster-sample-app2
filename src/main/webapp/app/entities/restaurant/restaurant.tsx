  ...
  return (
    <div>
      <h2 id="restaurant-heading" data-cy="RestaurantHeading">
        <Translate contentKey="aaaApp.restaurant.home.title">Restaurants</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="aaaApp.restaurant.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/restaurant/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="aaaApp.restaurant.home.createLabel">Create new Restaurant</Translate>
          </Link>
        </div>
      </h2>
        ...
        {restaurantList && restaurantList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="aaaApp.restaurant.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('preparationCommande')}>
                  <Translate contentKey="aaaApp.restaurant.preparationCommande">Preparation Commande</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('preparationCommande')} />
                </th>
                <th className="hand" onClick={sort('heureDePreparation')}>
                  <Translate contentKey="aaaApp.restaurant.heureDePreparation">Heure De Preparation</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="aaaApp.restaurant.home.notFound">No Restaurants found</Translate>
            </div>
          )
        )}
      </div>
