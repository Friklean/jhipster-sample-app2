  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="aaaApp.restaurant.home.createOrEditLabel" data-cy="RestaurantCreateUpdateHeading">
            <Translate contentKey="aaaApp.restaurant.home.createOrEditLabel">Create or edit a Restaurant</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('aaaApp.restaurant.preparationCommande')}
              ...
              />
              <ValidatedField
                label={translate('aaaApp.restaurant.heureDePreparation')}
