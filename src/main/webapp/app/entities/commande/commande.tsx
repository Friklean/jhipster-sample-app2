  ...
  return (
    <div>
      <h2 id="commande-heading" data-cy="CommandeHeading">
        <Translate contentKey="aaaApp.commande.home.title">Commandes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="aaaApp.commande.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/commande/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="aaaApp.commande.home.createLabel">Create new Commande</Translate>
          </Link>
        </div>
      </h2>
        ...
        {commandeList && commandeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="aaaApp.commande.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('listeArticle')}>
                  <Translate contentKey="aaaApp.commande.listeArticle">Liste Article</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('listeArticle')} />
                </th>
                <th className="hand" onClick={sort('heureDeCommande')}>
                  <Translate contentKey="aaaApp.commande.heureDeCommande">Heure De Commande</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('heureDeCommande')} />
                </th>
                <th className="hand" onClick={sort('paiement')}>
                  <Translate contentKey="aaaApp.commande.paiement">Paiement</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('paiement')} />
                </th>
                <th>
                  <Translate contentKey="aaaApp.commande.restaurant">Restaurant</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="aaaApp.commande.client">Client</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="aaaApp.commande.home.notFound">No Commandes found</Translate>
            </div>
          )
        )}
      </div>
