  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="aaaApp.commande.home.createOrEditLabel" data-cy="CommandeCreateUpdateHeading">
            <Translate contentKey="aaaApp.commande.home.createOrEditLabel">Create or edit a Commande</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('aaaApp.commande.listeArticle')}
              ...
              />
              <ValidatedField
                label={translate('aaaApp.commande.heureDeCommande')}
              ...
              />
              <ValidatedField
                label={translate('aaaApp.commande.paiement')}
              ...
              />
              <ValidatedField
                label={translate('aaaApp.commande.restaurant')}
              ...
              <ValidatedField id="commande-client" name="client" data-cy="client" label={translate('aaaApp.commande.client')} type="select">
                <option value="" key="0" />
                {clients
